...
WAIT_ECHO:
    // Read the GPIO in register until BIT_ECHO goes high
    LBBO r2, r3, 0, 4
    QBBC WAIT_ECHO, r2, BIT_ECHO

    // Set r4 to 0 to measure the echo duration in microseconds, resolution is 1us
    MOV r4, 0
...
SAMPLE_ECHO_DELAY_1US:
    ...
    // Read the GPIO in register until BIT_ECHO goes low
    LBBO r2, r3, 0, 4
